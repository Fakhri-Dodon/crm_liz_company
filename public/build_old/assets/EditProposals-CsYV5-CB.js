...
`+l}</style>
        ...
        `.trim(),g=new Blob([m],{type:"text/html;charset=utf-8"}),y=URL.createObjectURL(g),u=document.createElement("a");u.href=y,u.download="proposal.html",u.click(),URL.revokeObjectURL(y)},ee=async()=>{if(!d.current)return;const e=d.current,n=e.getHtml(),s=new DOMParser().parseFromString(n,"text/html"),a=e.getConfig().canvas,o=async g=>{try{const u=await(await fetch(g)).text();return g.includes("font-awesome")?u:w(u,s)}catch{return""}},i=await Promise.all(a.styles.map(g=>o(g))),l=w(e.getCss(),s),c=i.join(`
`)+`
...
Apakah Anda yakin ingin kembali?`)||window.history.back()};return r.jsxs("div",{className:`builder-body ${G?"sidebar-expanded":"sidebar-collapsed"}`,children:[r.jsxs("div",{className:"menu-left",onMouseEnter:()=>E(!0),onMouseLeave:()=>{E(!1),T(!1)},style:{zIndex:1e3},children:[r.jsx("div",{className:"icon-trigger-area",children:r.jsx("i",{className:"fa fa-th-large fa-lg"})}),r.jsxs("div",{className:"main-nav",children:[r.jsxs("h3",{children:[r.jsx("i",{className:"fa fa-th-large"})," BLOCKS"]}),r.jsx("ul",{className:"elements-list",children:D.map(e=>r.jsx("li",{className:_===e?"active":"",children:r.jsx("a",{href:"#",onClick:n=>{n.preventDefault(),J(e)},children:e})},e))})]}),r.jsx("div",{className:`second-side ${U?"show":""}`,id:"second-side",children:r.jsxs("div",{className:"second-side-header",onClick:()=>T(!1),children:[r.jsx("i",{className:"fa fa-chevron-left"})," HIDE"]})})]}),r.jsxs("div",{className:"container-main",children:[r.jsxs("header",{className:"builder-header",children:[r.jsx(ne,{title:"Edit Template"}),r.jsxs("div",{className:"modes",children:[r.jsx("span",{className:"mode-label",children:"BUILDING MODE:"}),["elements","content","details"].map(e=>r.jsxs("label",{children:[r.jsx("input",{type:"radio",checked:L===e,onChange:()=>M(e),style:{marginRight:"2px",marginBottom:"2px"}}),e]}))]}),r.jsxs("div",{className:"flex items-center gap-2",children:[r.jsx("button",{onClick:se,className:`
