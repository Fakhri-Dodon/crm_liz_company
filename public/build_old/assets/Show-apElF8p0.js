import{j as e}from"./app-Dyd-VK-i.js";function p({html:s,css:t}){const r=`
        <!doctype html>
        <html>
        <head>
            <meta charset="utf-8"/>
    ...
    `;return e.jsx("iframe",{srcDoc:r,className:"w-full h-screen border rounded",sandbox:"allow-same-origin allow-scripts",title:"Preview"})}export{p as default};
