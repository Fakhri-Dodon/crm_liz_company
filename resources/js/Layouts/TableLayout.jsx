...
export default function TableLayout({
  ...
  const getPaginationRange = () => {
    ...
    const result = [];
    range.sort((a, b) => a - b).forEach((page, index, array) => {
  ...
  const getShowingRange = () => {
    ...
    const { currentPage = 1, itemsPerPage = 10, totalItems = 0 } = pagination;
              ...
              <tr>
                ...
                >
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-sm text-gray-400 mt-1">Start by adding some records</p>
                  </div>
                </td>
              </tr>
            ) : (
        ...
        <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-1">
              {/* First Page */}
              <button
                onClick={() => pagination.onPageChange && pagination.onPageChange(1)}
              ...
              {getPaginationRange().map((page, index) => (
                page === '...' ? (
                  ...
                  <button
                    key={page}
                    onClick={() => pagination.onPageChange && pagination.onPageChange(page)}
              ...
              {/* Last Page */}
              <button
                onClick={() => pagination.onPageChange && pagination.onPageChange(pagination.totalPages)}
                disabled={pagination.currentPage === pagination.totalPages}
                className="p-2 text-gray-600 hover:text-gray-900 hover:bg-white rounded-lg border border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:text-gray-600 disabled:hover:bg-transparent transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                title="Last page"
              >
