...
export default function LeadSettings() {
    ...
    useEffect(() => {
        if (config) {
            setLocalSettings({
                lead_user_base_visibility: toBool(
                    config.lead_user_base_visibility
                ),
                lead_default_filter_by_login: toBool(
                    config.lead_default_filter_by_login
                ),
            });
        }
    }, [config]);
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    ...
                                    <TableRow className="border-b">
                                        <TableCell className="font-medium px-4 text-center border-r">
                                        ...
                                        <TableCell className="text-center py-6 border-r">
                                            <div className="flex flex-col items-center gap-1">
                                                <Switch
                                                    ...
                                                    checked={
                                                        localSettings.lead_user_base_visibility
                                                    }
                                                    onCheckedChange={() =>
                                                        handleToggle(
                                        ...
                                        <TableCell className="px-4 text-sm border-r">
                                            Restrict users to see only Leads
                                            they{" "}
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell className="text-center py-6 border-r">
                                            <div className="flex flex-col items-center gap-1">
                                                <Switch
                                                    ...
                                                    checked={
                                                        localSettings.lead_default_filter_by_login
                                                    }
                                                    onCheckedChange={() =>
                                                        handleToggle(
                                        ...
                                        <TableCell className="px-4 text-sm border-r">
                                            Automatically filter Lead table to
                                            show only data related to the
                                            logged-in user.
                                        </TableCell>
                                        <TableCell className="px-4 text-sm bg-gray-50/50 italic text-gray-600">
                                            ...
                                            , table shows all visible Leads
                                            initially; user can still filter
                                            manually.
                                        </TableCell>
                                    </TableRow>
                                </TableBody>
